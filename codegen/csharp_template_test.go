...
func TestGenerateCSharpCreateClientTemplateWiresGeneratedCodecs(t *testing.T) {
	...
	for _, want := range []string{
		...
		"[Obsolete(\"Use Func<GolemConnectOptions, IGolemTransport>",
		...
		"GolemWebTransportTransport.FromConnectOptions(options)",
