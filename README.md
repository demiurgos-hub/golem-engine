...
[![Release](https://img.shields.io/badge/release-v0.3.0-orange.svg)](CHANGELOG.md)
...
Golem Engine is at **v0.3.0**. Public APIs and generated output may still change between releases; see [`CHANGELOG.md`](CHANGELOG.md) for details.
